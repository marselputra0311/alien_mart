    ...
    <div class="container-fluid mt-5 pt-3">
      ...
      <form action="controler_makanan.php" method="post" enctype="multipart/form-data" class="fs-5 fw-medium">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nama" id="nama" class="form-control" style="border: 1px solid rgb(49, 49, 49);" placeholder="Kuaci Rebo">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" name="tambah_makanan" class="btn btn-primary fw-medium">Tambah makanan</button>
      </form>
    </div>
  </div>
