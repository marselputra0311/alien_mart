...
$sql = "SELECT * FROM minuman WHERE barcode = '$barcode'";
$query = mysqli_query($conn, $sql);
$minuman = mysqli_fetch_assoc($query);
?>
...
<body>
  ...
  <div class="container">
    <div class="container-fluid mt-5 pt-3">
      <h1 class="text-center mb-4">Edit data minuman</h1>
      <form action="controler_minuman.php" method="post" enctype="multipart/form-data" class="fs-5 fw-medium">
        <div class="mb-3">
          ...
          <input type="text" name="barcode" id="barcode" class="form-control" style="border: 1px solid rgb(49, 49, 49);" readonly value="<?php echo $minuman['barcode'] ?>">
        </div>
        <div class="mb-3">
          <label for="nama" class="form-labe">Nama</label>
          <input type="text" name="nama" id="nama" class="form-control" style="border: 1px solid rgb(49, 49, 49);" value="<?php echo $minuman['nama'] ?>">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" name="qty" id="qty" class="form-control" style="border: 1px solid rgb(49, 49, 49);" min="0" value="<?php echo $minuman['qty']; ?>">
        </div>
        <button type="submit" name="edit_minuman" class="btn btn-warning fw-medium" style="color: #fff;">Edit minuman</button>
      </form>
    </div>
  </div>
